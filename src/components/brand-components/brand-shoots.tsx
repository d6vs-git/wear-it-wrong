...
const audioSegments: AudioSegment[] = [
  {
    id: "bg-occasion",
    type: "background",
    src: "/assets/sounds/brand-shoots/back-to-friends-somber.mp3",
    start: 0,
    volume: 0.38,
    loopSegment: false,
  },];
  ...
  return (
    <div className="w-screen overflow-hidden pt-16 md:pt-20">
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 mt-6 sm:mt-8 mb-8 sm:mb-12">
        <div className="flex flex-col-reverse lg:flex-row gap-70 md:gap-10 lg:gap-4">
